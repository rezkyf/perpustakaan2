	...
	<table class="table table-striped">
           ...
           <?php
				...
				{	
					...
					$doc = new DOMDocument();
					$doc->load('http://localhost/perpustakaan/provider/provider_perpus3.php?judul='.$judul);
			...
			//kondisi pada saat pencarian buku berdasarkan pengarang
				...
				$doc = new DOMDocument();
				$doc->load('http://localhost/perpustakaan/provider/provider_perpus3.php?pengarang='.$pengarangku);
